...
<html>
    <head>
		...
		<meta property="og:image" content="http://casarotte.com/images/philipe-casarotte-website.png"/>
    ...
    <body>
		...
		<section id="bio">
			...
			<div>
				<p>My diverse background includes roles in client relations, project management, front- and back-end development, UX/UI and digital strategy. I enjoy leading teams and collaborating with people from all disciplines to produce creative digital products. My ability to deeply understand the technical aspects of web development as well as the business and marketing facets allows me to quickly connect with other team members and clients.</p>
