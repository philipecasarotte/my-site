...
<html ng-app>
    ...
    <body>
		...
		<section id="bio">
			...
			<div>
				<p>At Jukin we want to crack the code of videos and the reason why we all love watching them. At Jukin we want to crack the code of videos and the reason why we all love watching them. I work alongside stakeholders, and engineers in product improvements, user interviews, data analyses and modeling, and designing unique user experiences to our internal and externals audiences.</p>
				<p>My diverse background includes roles in client relations, project management, front- and back-end development, UX/UI and digital strategy. I enjoy collaborating with people from all disciplines to produce creative digital products.</p>
				<h3>Previous Experiences</h3>
				<p>At <a href="http://www.dburnsdesign.com">DBurns</a>, I guided clients in all aspects of their web development project from the initial strategy and scope to the project management. I strategized end-to-end launch plans for clients' products and services.</p>
